  ...
  return (
    <section style={{ paddingBlock: "clamp(56px,8vw,112px)" }}>
      <div style={{ width: "min(1240px, 100% - 32px)", marginInline: "auto" }}>
        ...
        {/* Cards — unified lilac-50 palette */}
          ...
          {techniques.map((t, i) => (
            <div
              ...
              style={{
                ...
                border: "1.5px solid var(--color-lilac-200)",
                borderRadius: 24,
                minHeight: 360,
              }}
            >
              ...
              <div
                ...
                style={{ color: "var(--color-lilac-700)", opacity: .5 }}
              >
                <Sparkle size={20} />
              </div>
              ...
              <div
                ...
                style={{ fontSize: 64, color: "var(--color-lilac-700)", opacity: .9 }}
              >
                0{i + 1}
              </div>
              ...
              <div>
                ...
                <span
                  ...
                  style={{ color: "var(--color-lilac-700)" }}
                >
                  {t.tagline}
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-[6px] mt-auto">
                {t.includes.map((it) => (
                  <span
                    key={it}
                    className="text-[11.5px] font-semibold px-[10px] py-[5px] rounded-full bg-white"
                    style={{
                      color: "var(--color-ink)",
